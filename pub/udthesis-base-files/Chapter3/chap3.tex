...
\begin{figure}
	\centering
	\subfloat[Velocity plot with $Re = 100$]{
		\includegraphics[scale = 0.4]{Chapter3/CavityFlow_Quiver_100}
		\label{quiv_cavityflow_100}
	}
	\subfloat[Velocity plot with $Re = 1000$]{
		\includegraphics[scale = 0.4]{Chapter3/CavityFlow_Quiver_1000}
		\label{quiv_cavityflow_1000}
	} 
	\caption{Velocity plot of solution to (\ref{reg_cavity_flow})--(\ref{cavityflow_initalguess}), with $Re=100,1000$.}
	
	\label{reg_cavity_flow_residuals_plots}
\end{figure}
