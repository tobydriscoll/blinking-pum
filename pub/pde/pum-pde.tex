...
% REQUIRED
\begin{keywords}
  partition of unity, polynomial interpolation, Chebfun, domain decomposition, additive Schwarz
\end{keywords}
...
\begin{figure}
  ...
  \subfloat[Nonlinear residuals with $Re = 100$]{
    \includegraphics[scale = 0.4]{CavityFlow100}
    \label{cavityflow_100}
  }
  \subfloat[Nonlinear residuals with $Re = 1000$]{
    \includegraphics[scale = 0.4]{CavityFlow1000}
...
\begin{figure}
  \centering
  \includegraphics[scale = 0.6 ]{BurgersGrid}
...
\begin{figure}
  ...
  \subfloat[Nonlinear residuals with $\nu = 1/400$]{
    \includegraphics[scale = 0.34]{Burgers_400}
    \label{burgers_200}
  }
  \subfloat[Nonlinear residuals with $\nu = 1/800$]{
    \includegraphics[scale = 0.34]{Burgers_800}
    \label{burgers_800}
  }
  
    \subfloat[Nonlinear residuals with $\nu = 1/1000$]{
    \includegraphics[scale = 0.34]{Burgers_1000}
    \label{burgers_1200}
  }
  \subfloat[Nonlinear residuals with $\nu = 1/1500$]{
    \includegraphics[scale = 0.34]{Burgers_1500}
    \label{burgers_1600}
  }
