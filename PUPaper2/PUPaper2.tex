...
\newcommand{\child}[1]{child\textsubscript{#1}}
...
These algorithms can easily be vectorized to evaluate $s(\vect{x})$ at a set of points. (How is it easy?? And what is special about the case of evaluating on a grid??)
